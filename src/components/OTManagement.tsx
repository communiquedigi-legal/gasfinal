                  ...
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Select surgeon">
                        {newOp.surgeonId ? (staff.find(u => String(u.id).toLowerCase() === String(newOp.surgeonId).toLowerCase())?.name || newOp.surgeonId) : undefined}
                      </SelectValue>
                    </SelectTrigger>
                    <SelectContent>
                      {doctors.map(u => (
                    ...
                    >
                      <SelectTrigger className="text-xs h-10">
                        <SelectValue placeholder="Select OT Room">
                          {newInfectionLog.theatreId ? (theatres.find(t => String(t.id).toLowerCase() === String(newInfectionLog.theatreId).toLowerCase())?.name || newInfectionLog.theatreId) : undefined}
                        </SelectValue>
                      </SelectTrigger>
                      <SelectContent>
                        {theatres.map(t => (
                      ...
                      >
                        <SelectTrigger className="text-xs h-10">
                          <SelectValue placeholder="Select clean type">
                            {newInfectionLog.cleaningType === 'Routine' && 'Routine Quick Clean'}
                            {newInfectionLog.cleaningType === 'Fumigation' && 'Full Fumigation Cycle'}
                            {newInfectionLog.cleaningType === 'Post-op Deep Clean' && 'Post-op Deep Sterilization'}
                          </SelectValue>
                        </SelectTrigger>
                        <SelectContent>
                      ...
                      >
                        <SelectTrigger className="text-xs h-10">
                          <SelectValue placeholder="Select outcome">
                            {newInfectionLog.cultureSwabResult === 'Negative' && 'Negative (Clear Sterile)'}
                            {newInfectionLog.cultureSwabResult === 'Positive' && 'Positive (Contaminated!)'}
                            {newInfectionLog.cultureSwabResult === 'Pending' && 'Pending Incubator'}
                          </SelectValue>
                        </SelectTrigger>
                        <SelectContent>
